...
<form action="${pageContext.servletContext.contextPath}/register" method="POST">
    ...
    <input class="inputForm"   pattern="[A-Za-zА-Яа-яЁё]{2,20}" type="text" id="name" name="name" placeholder="Name" autocomplete="off">

    <label for="secondName">Second name :</label>
    <input class="inputForm"  pattern="[A-Za-zА-Яа-яЁё]{2,20}" type="text" id="secondName" name="secondName" placeholder="Second name" autocomplete="off">
